                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading panel-heading-transparent">
                            <strong>รายงานการโอนที่ Line@ <?php
                                if (isset($_GET['date'])) {
...
//                                echo $data2;
                        ...
                        <div class="panel-body">
                            <form class="" action="reportLine.php" method="get" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-2 pull-right margin-top-20">
                                        ...
                                        if (isset($_GET['date']) && $_GET['date'] != "" && $result_row != 1) {
                                            ?>
                                            <a href="php/pdf/line.php?date=<?= $_GET['date'] ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="location" value="reportLine">
