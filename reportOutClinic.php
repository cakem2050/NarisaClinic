                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading panel-heading-transparent">
                            <strong>รายงานการโอนที่นอก clinic</strong>

                        </div>
                        <div class="panel-body">
                            <form class="" action="reportOutClinic.php" method="get" enctype="multipart/form-data" data-success="Sent! Thank you!" data-toastr-position="top-right">
                                <fieldset>
                                    <div class="row">
                            ...
                            <i class=\"glyphicon glyphicon-trash\"></i>ยกเลิกรายการ
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                        $sql_pay = "SELECT SUM(bills_pay),SUM(bills_discount),SUM(bills_ost),SUM(bills_net) FROM bills WHERE bills_datetime LIKE :datecheck AND bills_status = 'E' AND bills_ptype = 'TO'";
                            ...
                            <div class="row">
                                <div class="col-md-2 col-sm-2 pull-right margin-top-20">
                                    ...
                                    if(isset($_GET['date']) && $_GET['date'] != "" && $result_row != 1) {
                                        ?>
                                        <a href="php/pdf/outClinic.php?date=<?=$_GET['date']?>" class="btn btn-3d btn-teal btn-ms btn-block" id="print">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="location" value="reportOutClinic">
