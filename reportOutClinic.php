                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading panel-heading-transparent">
                            <strong>รายงานการโอนที่นอก clinic <?php
                                if (isset($_GET['date'])) {
...
//                                echo $data2;
                        ...
                        <div class="panel-body">
                            <form class="" action="reportOutClinic.php" method="get" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-2 pull-right margin-top-20">
                                        ...
                                        if (isset($_GET['date']) && $_GET['date'] != "" && $result_row != 1) {
                                            ?>
                                            <a href="php/pdf/outClinic.php?date=<?= $_GET['date'] ?>"
